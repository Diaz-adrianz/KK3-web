<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($nis)) {
            ...
            $mysqli -> query("UPDATE siswa SET nis = '$nis', nama_lengkap = '$nama', jenis_kelamin = '$jk', jurusan = '$jrsn', alamat = '$alamat', gol_darah = '$goldar', nama_ibu_kandung = '$ibu', file = '$file', id_kelas = '$idKelas' WHERE nis = '$nis' ") or die ($mysqli -> error);
